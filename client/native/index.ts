...
const zbbAutomation = {
  ...
  // OCR 段已删除 2026-06-25（recognizeText/recognizeTextWithPosition/screenContainsText/findTextByMLKit/findTextByMLKitWithPermission 内部调 OCR）
  // 还原: git log 查 native/index.ts L217-L336
  ...
  // OCR 段已删除 2026-06-25（screenshotAndMark + ocrLatestScreenshot 内部调 OCR）
  // 还原: git log 查 native/index.ts L1225-L1316
  // 注：原 3 个重复方法 stopVibration/startPulseVibration/showToast 也已清理（保留 L576/L592/L1077 主定义）
};
